        ...
        <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                        <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-sky-600 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50" name="remember">
                        <label for="remember_me" class="ml-2 block text-sm text-gray-700">Remember me</label>
                    </div>
                    @if (Route::has('password.request'))
                        <a class="text-sm text-sky-600 hover:text-sky-800 transition-colors duration-200" href="{{ route('password.request') }}">
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('register') }}" class="text-sky-600 hover:text-sky-800 font-semibold transition-colors duration-200">
                        Register
                    </a>
                </p>
            </div>
